  ...
  return (
    <div className="w-full max-w-[1600px] mx-auto space-y-6 sm:space-y-8 pb-12">
      ...
      <div className="pt-6 border-t border-[#ECE7DB] flex items-center justify-between gap-4 mt-8">
        <Link
          href="/admin/locations"
          className="px-6 py-3 rounded-xl border border-[#E8E1D4] bg-white text-sm font-semibold text-gray-700 hover:bg-[#FAFAF8] transition-all shadow-2xs"
        >
          Cancel
        </Link>
        ...
        <div className="flex items-center gap-3">
          <button
            ...
            className="px-6 py-3 rounded-xl border border-[#C89B1C] bg-white text-sm font-semibold text-[#B8860B] hover:bg-[#FFFDF6] transition-all cursor-pointer shadow-2xs"
          >
            Save Draft
          </button>
          ...
          <button
            ...
            className="px-7 py-3 rounded-xl bg-gradient-to-r from-[#C89B1C] to-[#D8B75A] hover:from-[#b68c17] hover:to-[#c7a74a] text-white text-sm font-bold shadow-md hover:shadow-lg transition-all flex items-center gap-2 cursor-pointer"
          >
            <Send size={16} />
