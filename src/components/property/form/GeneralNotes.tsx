  ...
  return (
    ...
    >
      ...
      <div className="flex items-center gap-5 mb-8">
        ...
        <div
          className="h-16 w-16 rounded-2xl bg-[#FFF8EA] text-[#C89B1C] flex items-center justify-center"
        >
          <FileText size={30} />
        </div>
...
• Suitable for families"
          className="w-full rounded-3xl border border-[#E6DDCC] bg-[#FCFBF8] p-6 text-[15px] leading-7 resize-none outline-none transition-all duration-300 focus:border-[#C89B1C] focus:ring-4 focus:ring-[#C89B1C]/10"
        />

        <div
          className="absolute bottom-5 right-6 text-sm text-gray-500"
        >
      ...
      <div
        className="mt-8 rounded-2xl border border-[#F4E5B2] bg-[#FFFBEF] p-5"
      >
