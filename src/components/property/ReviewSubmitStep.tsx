...
import { CheckCircle2, AlertTriangle, FileText, MapPin, Landmark, DollarSign, User, ShieldCheck } from "lucide-react";
  ...
  return (
    <div className="space-y-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className="bg-white border border-[#E5D8B3] rounded-2xl p-5 space-y-4 shadow-2xs">
          <h3 className="text-sm font-bold text-gray-800 uppercase tracking-wider border-b border-gray-100 pb-2 flex items-center gap-2">
        ...
        <div className="bg-white border border-[#E5D8B3] rounded-2xl p-5 space-y-4 shadow-2xs">
          ...
          <div className="space-y-2 text-sm">
            <div className="flex justify-between">
              ...
              <span className="font-bold text-[#C89B1C] text-base">{formatPrice(formData.price)}</span>
            </div>
            <div className="flex justify-between">
      ...
      {/* Verification Notice */}
      <div className="bg-[#FFFDF9]/60 border border-[#E5D8B3] rounded-2xl p-5 flex gap-3.5 items-start">
